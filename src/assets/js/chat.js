...
export const textChat = async (chatQst, src_val, tar_val) => {
  ...
  try {
    ...
    chatQst = null;
    const Ans_text = response.data.responded_text;
...
export const audioChat = async (audioBlob, tar_val) => {
  if (audioBlob) {
